...
function Q6MenuBar(objName, barName) {
	...
	this.colors[3] = {
		menuBgColor:"#FFC1C1",
		menuBorderColor:"#FFF0F5",
		itemBgColor:"#FFF8DC",
		itemBorderColor:"#FFC1C1",
		itemBgMoveColor:"#FFC1C1",
		itemBorderMoveColor:"#ffb8b8",
		itemMoveColor:"#FFA500",
		itemColor:"#9370DB",
		menuBarColor:"#FA8072",
		menuContentColor:"#D8BFD8"
	};
	...
	this.colors[4] = {
		...
		menuBorderColor:"#FFF0F5",
		itemBgColor:"#FFF8DC",
		itemBorderColor:"#ffb8b8",
		itemBgMoveColor:"#FFAEB9",
		itemBorderMoveColor:"#fef2f2",
		itemMoveColor:"#FFFFFF",
		itemColor:"#FFB6C1",
		menuBarColor:"#FFFFFF",
		menuContentColor:"#fef2f2"
	};
	this.font = {
	};
	this.menus = [];
