...
<html>
  ...
  <body style="background-image:url(../images/welcome.jpg); background-repeat:no-repeat;background-attachment:fixed">
    <h2 style="text-align: center; color: #FF7F50">分类列表</h2>
...
<c:forEach items="${parents }" var="parent">    	
    	<tr class="trOneLevel">
    		...
    		<td width="200px;" align="center">
    		  <a href="<c:url value='/AdminCategoryServlet?method=addChildPre&pid=${parent.cid }'/>">添加小类</a>
    		  <a href="<c:url value='/AdminCategoryServlet?method=editParentPre&cid=${parent.cid }'/>">修改</a>
    		  <a onclick="return confirm('您是否真要删除该大类？')" href="<c:url value='/AdminCategoryServlet?method=deleteParent&cid=${parent.cid }'/>">删除</a>
    		</td>
    	</tr>
   <c:forEach items="${parent.children }" var="child">
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="center">
    		  ...
    		  <a onclick="return confirm('您是否真要删除该小类？')" href="<c:url value='/AdminCategoryServlet?method=deleteChild&cid=${child.cid }'/>">删除</a>
    		</td>
    	</tr>
   </c:forEach>
</c:forEach>
