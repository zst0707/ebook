...
public class AdminAddBookServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sfu.setFileSizeMax(1024*1024);//设置单个上传的文件上限
        /*
        ...
        try {
            ...
            e.printStackTrace();
            error("上传的文件大小超出了限制", request, response);
            return;
        }
    ...
    private void error(String msg, HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("parents", new CategoryServiceImpl().findParents());//所有一级分类
